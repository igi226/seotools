@section('site_title', formatTitle([__('Upper To Lower Case'), __('Tool'), config('settings.title')]))
...
<div class="d-flex">
    <h1 class="h2 mb-3 text-break">{{ __('Upper To Lower Case') }}</h1>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-header align-items-center">
        <div class="row">
            <div class="col">
                <div class="font-weight-medium py-1">{{ __('Upper To Lower Case') }}</div>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('tools.processUpperToLowerCase') }}" method="post" enctype="multipart/form-data" @cannot('contentTools', ['App\Models\User']) class="position-absolute left-5 right-5 opacity-20" @endcannot>
