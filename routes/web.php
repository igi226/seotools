...
Route::prefix('tools')->middleware('tools')->group(function () {
    ...
    //pradipta
    Route::get('/doc-to-pdf', 'ToolController@docToPdfConverter')->name('tools.docToPdfConverter');
    Route::post('/doc-to-pdf-process', 'ToolController@processdocToPdfConverter')->name('tools.processdocToPdfConverter');

    Route::get('/upper-to-lower-case', 'ToolController@upperToLowerCase')->name('tools.upperToLowerCase');
    Route::post('/upper-to-lower-process', 'ToolController@processUpperToLowerCase')->name('tools.processUpperToLowerCase');
